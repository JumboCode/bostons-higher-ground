...
function ChartEntry() {
    return (
        <div className="mx-10 border-2 border-gray-200 py-2 px-8 rounded-xl">
            this is one chart entry haha
        </div>
    );
}
    ...
    return (
        <div>
            ...
            <div className="h-full mx-96 my-5 px-10 py-10 rounded-l-lg border-4 border-indigo-500">
                <div className="text-lg font-semibold mb-4">Report Builder</div> {/*main title*/}
