                ...
                <div className="flex flex-col border-0 p-8 rounded-3xl bg-white space-y-8 shadow-[0px_24px_50px_0px_rgba(167,_74,_91,_0.2)] max-w-[400px]">
                    ...
                    <form className="space-y-6">
                        <div className="flex flex-col space-y-1">
                            ...
                            <input name="temp-code" placeholder="name@higherground.org" className="bg-[#F3F3F5] py-2 rounded-2xl px-3 "/>
                        </div>
                        <div className="flex flex-col space-y-1">
                            <div className="space-x-1">
                            ...
                            <input name="temp-code" placeholder="750WEFT" className="bg-[#F3F3F5] py-2 rounded-2xl px-3 "/>
                        </div>
                        <button className="flex py-2.5 w-full rounded-xl text-white justify-center bg-[#E76C82] space-x-1">
                            <p>Continue</p>
